...
import { CarouselFilms, CarouselFilmsProps } from "./CarouselFilms"


export default {
    title: "Components/CarouselFilms",
    component: CarouselFilms
}

const propsBase: CarouselFilmsProps = {
    films: [
        {
            "id": "1",
            "name": "Titanic",
...
export const carouselFilms = () => <CarouselFilms {...propsBase} />